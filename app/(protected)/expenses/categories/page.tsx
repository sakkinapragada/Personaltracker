  ...
  return (
    <div>
      ...
      <p className="mb-6 text-sm text-ink-soft">
        Group expenses into categories like Food or Rent so your dashboard and trends make sense
        at a glance. New categories get a unique color automatically — rename or recolor anytime.
      </p>
